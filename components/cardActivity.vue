...
<template>
  <div class="relative">
    ...
    <div
      class="bg-[#1d204b] rounded-xl text-[10px] -mt-5 w-full py-7"
    ...
    >
      <div class="-mt-2 ml-5">
        ...
        <p class="text-3xl mt-5 mb-3 font-thin">{{ timeframes.current }}hrs</p>
        <p>Last Week - {{ timeframes.previous }}hrs</p>
      </div>
    </div>
  </div>
</template>
